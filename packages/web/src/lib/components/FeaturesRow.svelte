<script lang=ts>
  export let features = [
    {
      title: 'Branding',
      content: 'Share relevant, engaging, and inspirational brand messages to create a connection with your audience.',
    },
    {
      title: 'Branding',
      content: 'Share relevant, engaging, and inspirational brand messages to create a connection with your audience.',
...
<div class="sm:flex flex-wrap justify-center items-center text-center gap-8">
    ...
    <div class={`w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6 shadow-lg rounded-lg dark:bg-gray-800 ${index === 1 ? 'sm:mt-16 md:mt-20 lg:mt-24' : ''}`}>
